...
class RecetteController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated = $request->validate([
            ...
            'temps_repos.required' => 'Le temps de repos est obligatoire.',
            'temps_total.required' => 'Le temps total est obligatoire.',
            'portion.required' => 'Le nombre de portions est obligatoire.',
            'difficulte.required' => 'La difficulté est obligatoire.',
            'type.required' => 'Le type est obligatoire.',
            'ingredients.required' => 'Les ingrédients sont obligatoires.',
            'quantites.required' => 'Les quantités sont obligatoires.',
            'unites.required' => 'Les unités sont obligatoires.',
            'steps.required' => 'Les étapes sont obligatoires.',
            'order.required' => 'L\'ordre des étapes est obligatoire.',
            'imageUrl.dimensions' => 'L\'image doit avoir une taille minimale de 300x300 pixels et maximale de 1500x1500 pixels.',
            'imageUrl.image' => 'Le fichier téléchargé doit être une image.',
            'imageUrl.mimes' => 'L\'image doit être de type jpeg, png, jpg ou webp.',
            'imageUrl.max' => 'L\'image ne doit pas dépasser 2 Mo.',
